    ...
    <div class="settings-container">
      ...
      <div class="settings-content">
        <el-tabs v-model="activeTab" class="settings-tabs">
          <!-- 登录注册 / 账户管理 -->
          <el-tab-pane
            :label="userStore.isLoggedIn ? '账户管理' : '登录注册'"
            name="auth"
          >
            ...
            <div class="settings-section">
              ...
              <div v-if="!userStore.isLoggedIn" class="login-required">
                <el-empty description="请先登录以设置饮食偏好">
                  <el-button type="primary" @click="activeTab = 'auth'"
                    >去登录</el-button
                  >
                </el-empty>
              </div>
                ...
                <div class="preference-groups">
                  ...
                  <div class="preference-group">
                    ...
                    <el-checkbox-group v-model="preferences.dietTypes">
                      ...
                      <el-checkbox label="mediterranean"
                        >地中海饮食</el-checkbox
                      >
                  ...
                  <div class="preference-group">
                    ...
                    <div class="taste-preferences">
                      <div class="taste-item">
                        <span>辣度偏好</span>
                        <el-slider
                          v-model="preferences.spiciness"
                          :max="5"
                          show-stops
                        />
                        <span class="taste-label">{{
                          getSpicinessLabel(preferences.spiciness)
                        }}</span>
                      </div>
                      <div class="taste-item">
                        <span>甜度偏好</span>
                        <el-slider
                          v-model="preferences.sweetness"
                          :max="5"
                          show-stops
                        />
                        <span class="taste-label">{{
                      ...
                      <div class="taste-item">
                        <span>咸度偏好</span>
                        <el-slider
                          v-model="preferences.saltiness"
                          :max="5"
                          show-stops
                        />
                        <span class="taste-label">{{
                          getSaltinessLabel(preferences.saltiness)
                        }}</span>
                      </div>
                    </div>
                  </div>
          ...
          <el-tab-pane label="隐私设置" name="privacy">
            <div class="settings-section">
              ...
              <div class="privacy-actions">
                <el-button type="primary" @click="savePrivacy"
                  >保存设置</el-button
                >
              </div>
            </div>
...
const addDislikedIngredient = () => {
  if (
    newIngredient.value &&
    !preferences.dislikedIngredients.includes(newIngredient.value)
  ) {
